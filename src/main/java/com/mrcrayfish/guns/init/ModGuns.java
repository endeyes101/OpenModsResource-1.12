...
public class ModGuns
{
    ...
    {
        register(new ItemGun(new ResourceLocation(Reference.MOD_ID, "handgun")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemGun(new ResourceLocation(Reference.MOD_ID, "shotgun")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemGun(new ResourceLocation(Reference.MOD_ID, "rifle")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemGun(new ResourceLocation(Reference.MOD_ID, "grenade_launcher")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemGun(new ResourceLocation(Reference.MOD_ID, "bazooka")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemGun(new ResourceLocation(Reference.MOD_ID, "chain_gun")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemGun(new ResourceLocation(Reference.MOD_ID, "assault_rifle")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemGun(new ResourceLocation(Reference.MOD_ID, "machine_pistol")).setCreativeTab(CreativeTabs.COMBAT));

        register(new ItemAmmo(new ResourceLocation(Reference.MOD_ID, "basic_ammo")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemAmmo(new ResourceLocation(Reference.MOD_ID, "advanced_ammo")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemAmmo(new ResourceLocation(Reference.MOD_ID, "shell")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemAmmo(new ResourceLocation(Reference.MOD_ID, "missile")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemGrenade(new ResourceLocation(Reference.MOD_ID, "grenade")).setCreativeTab(CreativeTabs.COMBAT));
        register(new ItemStunGrenade(new ResourceLocation(Reference.MOD_ID, "stun_grenade")).setCreativeTab(CreativeTabs.COMBAT));
