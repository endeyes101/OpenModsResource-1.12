...
public class GunConfig
{
	...
	public static class Server
	{
		...
		public double headShotDamageMultiplier = 2.0;
	}
		...
		public void setExemptionClasses()
		{
			...
			for (String className : exemptClassNames)
			{
				...
				try
				{
					...
					{
						MrCrayfishMod.logger.warn(prefix + "' must exend EntityLivingBase.");
					}
				}
				catch (ClassNotFoundException e)
				{
					MrCrayfishMod.logger.warn(prefix + "' was not found:", e);
				}
			}
		}
	}
