...
public class GunRegistry
{
    ...
    private static void loadProperties(ItemGun itemGun)
    {
        ...
        {
            MrCrayfishMod.logger.error("Failed to load gun json '" + itemGun.getRegistryName() + "'");
            e.printStackTrace();
            return;
        }
        ...
        {
            MrCrayfishMod.logger.error("Failed to validate gun fields for '" + itemGun.getRegistryName() + "'");
            e.printStackTrace();
            return;
        }
