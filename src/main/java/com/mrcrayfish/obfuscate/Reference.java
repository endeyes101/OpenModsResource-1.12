...
public class Reference
{
    ...
    public static final String CLIENT_PROXY_CLASS = "com.mrcrayfish.guns.proxy.ClientProxy";
    public static final String COMMON_PROXY_CLASS = "com.mrcrayfish.guns.proxy.CommonProxy";
}