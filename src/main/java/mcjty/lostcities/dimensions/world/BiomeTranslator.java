...
public class BiomeTranslator {
    ...
    private static List<Pair<String, Biome>> parseManualBiomes(String[] manualBiomeMappings) {
        ...
        for (String s : manualBiomeMappings) {
            ...
            if (biome != null && destBiome != null) {
                ...
                MrCrayfishMod.setup.getLogger().warn("Could not find biome '" + biomeId + "'!");
            } else if (destBiome == null) {
                MrCrayfishMod.setup.getLogger().warn("Could not find biome '" + destBiomeId + "'!");
            }
        }
        return mapping;
    }
    ...
    private void dumpTranslationMap() {
        MrCrayfishMod.setup.getLogger().info("Dumping biome mapping");
        for (Map.Entry<String, Biome> entry : translationMap.entrySet()) {
            ...
            MrCrayfishMod.setup.getLogger().info("biome: " + entry.getKey() + " -> " + entry.getValue().biomeName + " (" + biomeKey.toString() + ")");
        }
    }
