...
public class ModDimensions {
    ...
    public static void init() {
        ...
        if (LostCityConfiguration.DIMENSION_ID != -1) {
            lostDimensionType = DimensionType.register(MrCrayfishMod.MODID, "_lost", LostCityConfiguration.DIMENSION_ID, LostWorldProvider.class, false);
        ...
        for (String dimInfo : LostCityConfiguration.ADDITIONAL_DIMENSIONS) {
            ...
            if (lostDimensionType == null) {
                lostDimensionType = DimensionType.register(MrCrayfishMod.MODID, "_lost", id, LostWorldProvider.class, false);
            }
