...
public class LostCityConfiguration {
    ...
    public static String[] ASSETS = new String[] {
            "/assets/cgm/citydata/conditions.json",
            "/assets/cgm/citydata/palette.json",
            "/assets/cgm/citydata/palette_desert.json",
            "/assets/cgm/citydata/palette_chisel.json",
            "/assets/cgm/citydata/palette_chisel_desert.json",
            "/assets/cgm/citydata/highwayparts.json",
            "/assets/cgm/citydata/railparts.json",
            "/assets/cgm/citydata/monorailparts.json",
            "/assets/cgm/citydata/buildingparts.json",
            "/assets/cgm/citydata/library.json",
            "$cgm/userassets.json"
    };
    ...
    public static int DIMENSION_ID = 10000;
    public static boolean DIMENSION_BOP = true;

    public static boolean DEBUG = false;
    public static boolean OPTIMIZED_CHUNKGEN = true;

    public static String SPECIAL_BED_BLOCK = Blocks.BEDROCK.getRegistryName().toString();
...
//            MrCrayfishMod.setup.getLogger().info("Upgrading Lost Cities config from " + oldVersion + " to " + VERSION + "!");
        ...
        if (ModSetup.neid || ModSetup.jeid) {
            MrCrayfishMod.setup.getLogger().log(Level.INFO, "NEID or JEID detected: disabling optimized chunkgeneration!");
