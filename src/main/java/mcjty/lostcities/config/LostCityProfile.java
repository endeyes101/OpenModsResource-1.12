...
public class LostCityProfile {
    ...
    public static final String CATEGORY_LOSTCITY = "lostcities";
    ...
    public ResourceLocation getIcon() {
        ...
        icon = new ResourceLocation(MrCrayfishMod.MODID, iconFile);
        return icon;
    }
    ...
    public Map<String, Float> getBiomeFactorMap() {
        if (biomeFactorMap == null) {
            ...
            for (String s : CITY_BIOME_FACTORS) {
                ...
                if (split.length < 2) {
                    MrCrayfishMod.setup.getLogger().error("Badly specified biome factor. Must be <biome>=<factor>!");
                } else {
    ...
    public IBlockState getLiquidBlock() {
        if (liquidBlock == null) {
            ...
            if (b == null) {
                MrCrayfishMod.setup.getLogger().error("Bad liquid block: " + LIQUID_BLOCK + "!");
    ...
    public IBlockState getBaseBlock() {
        if (baseBlock == null) {
            ...
            if (b == null) {
                MrCrayfishMod.setup.getLogger().error("Bad base block: " + BASE_BLOCK + "!");
