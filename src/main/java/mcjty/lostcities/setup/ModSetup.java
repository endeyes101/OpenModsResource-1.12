...
//        PacketHandler.registerMessages("lostcities");
        ...
        LootTableList.register(new ResourceLocation(MrCrayfishMod.MODID, "chests/lostcitychest"));
        LootTableList.register(new ResourceLocation(MrCrayfishMod.MODID, "chests/raildungeonchest"));
    }
...
//        atg = Loader.isModLoaded("atg"); // @todo
    ...
    public void postInit(FMLPostInitializationEvent e) {
        ...
        for (String path : LostCityConfiguration.ASSETS) {
            if (path.startsWith("/")) {
                try(InputStream inputstream = MrCrayfishMod.class.getResourceAsStream(path)) {
