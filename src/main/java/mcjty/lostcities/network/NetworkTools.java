...
public class NetworkTools {
    ...
    public static FluidStack readFluidStack(ByteBuf dataIn) {
        ...
        try {
            ...
            MrCrayfishMod.setup.getLogger().log(Level.ERROR, "Error reading fluid stack", e);
        }
        return null;
    }
    ...
    public static void writeFluidStack(ByteBuf dataOut, FluidStack fluidStack) {
        ...
        try {
            ...
            MrCrayfishMod.setup.getLogger().log(Level.ERROR, "Error writing fluid stack", e);
        }
    }
    ...
    public static NBTTagCompound readTag(ByteBuf dataIn) {
        ...
        try {
            ...
            MrCrayfishMod.setup.getLogger().log(Level.ERROR, "Error reading tag", e);
        }
        return null;
    }
    ...
    public static void writeTag(ByteBuf dataOut, NBTTagCompound tag) {
        ...
        try {
            ...
            MrCrayfishMod.setup.getLogger().log(Level.ERROR, "Error writing tag", e);
        }
    }
    ...
    public static ItemStack readItemStack(ByteBuf dataIn) {
        ...
        try {
            ...
            MrCrayfishMod.setup.getLogger().log(Level.ERROR, "Error reading item stack", e);
        }
    ...
    public static void writeItemStack(ByteBuf dataOut, ItemStack itemStack) {
        ...
        try {
            ...
            MrCrayfishMod.setup.getLogger().log(Level.ERROR, "Error writing item stack", e);
        }
    }
